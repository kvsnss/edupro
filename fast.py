...
@st.cache_data
def load_data():
    users = pd.read_csv("data/EduPro Online Platform.xlsx - Users.csv")
    courses = pd.read_csv("data/EduPro Online Platform.xlsx - Courses.csv")
    transactions = pd.read_csv(
    "data/EduPro Online Platform.xlsx - Transactions.csv")
